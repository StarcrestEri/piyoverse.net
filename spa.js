...
(function(){
  ...
  // Ensure hover/outlines for game cards remain present after SPA swaps.
    try{
      ...
      _s.textContent = '\n@keyframes game-outline-sweep { 0% { background-position: 0px 0px, 100% 0px, 0px 100%, 0px 0px; } 100% { background-position: 720px 0px, 100% 720px, -720px 100%, 0px -720px; } }\n@keyframes game-outline-rotate { to { transform: rotate(360deg); } }\nhtml.frutiger-aero .game-card::after { content:""; position:absolute; top:6px; right:-4px; bottom:6px; left:-4px; border-radius:14px; box-shadow: 0 0 0 1px rgba(43,111,160,0.95) !important; background-repeat:no-repeat; background-image:none; background-size: 720px 6px, 6px 720px, 720px 6px, 6px 720px; background-position: 0px 0px, 100% 0px, 0px 100%, 0px 0px; opacity:1 !important; pointer-events:none; transition: box-shadow 180ms ease, opacity 180ms ease; z-index:2; }\nhtml.frutiger-aero .game-card:hover::after { box-shadow: 0 0 18px rgba(182,220,255,0.95) !important; background-image: repeating-linear-gradient(90deg, rgb(42,122,214) 0px, rgb(182,220,255) 360px, rgb(42,122,214) 720px), repeating-linear-gradient(180deg, rgb(42,122,214) 0px, rgb(182,220,255) 360px, rgb(42,122,214) 720px), repeating-linear-gradient(90deg, rgb(42,122,214) 0px, rgb(182,220,255) 360px, rgb(42,122,214) 720px), repeating-linear-gradient(180deg, rgb(42,122,214) 0px, rgb(182,220,255) 360px, rgb(42,122,214) 720px); background-repeat: repeat-x, repeat-y, repeat-x, repeat-y; animation: game-outline-sweep 1.6s linear infinite; z-index:3; }\n@supports (background: conic-gradient(from 0deg, #000, #fff)) {\n  html.frutiger-aero .game-card:hover::after { padding: 6px; box-sizing: border-box; background-image: conic-gradient(from 0deg, rgb(42,122,214) 0deg, rgb(182,220,255) 180deg, rgb(42,122,214) 360deg), linear-gradient(transparent, transparent); background-origin: border-box, padding-box; background-clip: border-box, padding-box; background-repeat: no-repeat; background-size: auto, auto; animation: game-outline-rotate 1.6s linear infinite; }\n}\nhtml.frutiger-aero .game-card::before { content:""; position:absolute; top:10px; bottom:6px; left:-4px; right:-4px; border-radius:12px; background-image: linear-gradient(to bottom, rgba(255,255,255,0.28), rgba(255,255,255,0.06)), linear-gradient(to bottom, rgba(182,220,255,0.12), rgba(255,255,255,0.00)), linear-gradient(to top, rgba(0,0,0,0.18), rgba(0,0,0,0.02)); background-position: top left, top left, bottom left; background-size: 100% 28px, 100% 28px, 100% 7px; background-repeat: no-repeat; opacity:0; pointer-events:none; transition: transform 180ms ease, opacity 180ms ease; z-index:1; }\nhtml.frutiger-aero .game-card:hover::before { opacity:1 !important; transform: translateY(-2px) !important; }\n';
