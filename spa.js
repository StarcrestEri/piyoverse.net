...
(function(){
  ...
  // Ensure hover/outlines for game cards remain present after SPA swaps.
    try{
      ...
      _s.textContent = '\n@keyframes game-outline-sweep { 0% { background-position: 0% 0%, 100% 0%, 100% 100%, 0% 100%; } 100% { background-position: 100% 0%, 100% 100%, 0% 100%, 0% 0%; } }\nhtml.frutiger-aero .game-card::after { content:""; position:absolute; top:6px; right:-4px; bottom:6px; left:-4px; border-radius:14px; box-shadow: 0 0 0 1px rgba(43,111,160,0.95) !important; background-repeat:no-repeat; background-image:none; background-size: 200% 3px, 3px 200%, 200% 3px, 3px 200%; background-position: 0% 0%, 100% 0%, 100% 100%, 0% 100%; opacity:1 !important; pointer-events:none; transition: box-shadow 180ms ease, opacity 180ms ease; z-index:2; }\nhtml.frutiger-aero .game-card:hover::after { box-shadow: 0 0 0 1px rgba(43,111,160,0.95), 0 0 0 3px rgba(182,220,255,0.95), 0 0 14px rgba(182,220,255,0.95) !important; background-image: linear-gradient(90deg, rgba(0,0,0,0), rgba(182,220,255,0.95), rgba(0,0,0,0)), linear-gradient(180deg, rgba(0,0,0,0), rgba(182,220,255,0.95), rgba(0,0,0,0)), linear-gradient(90deg, rgba(0,0,0,0), rgba(182,220,255,0.95), rgba(0,0,0,0)), linear-gradient(180deg, rgba(0,0,0,0), rgba(182,220,255,0.95), rgba(0,0,0,0)); animation: game-outline-sweep 1.6s linear infinite; }\nhtml.frutiger-aero .game-card::before { content:""; position:absolute; top:10px; bottom:6px; left:-4px; right:-4px; border-radius:12px; background-image: linear-gradient(to bottom, rgba(255,255,255,0.28), rgba(255,255,255,0.06)), linear-gradient(to bottom, rgba(182,220,255,0.12), rgba(255,255,255,0.00)), linear-gradient(to top, rgba(0,0,0,0.18), rgba(0,0,0,0.02)); background-position: top left, top left, bottom left; background-size: 100% 28px, 100% 28px, 100% 7px; background-repeat: no-repeat; opacity:0; pointer-events:none; transition: transform 180ms ease, opacity 180ms ease; z-index:1; }\nhtml.frutiger-aero .game-card:hover::before { opacity:1 !important; transform: translateY(-2px) !important; }\n';
